...
groups, we kindly request you to cite the following two papers:
...
Should you use this package for performing VAR-LiNGAM, we kindly request you to cite the following two papers:
...
Should you use this package for performing VARMA-LiNGAM, we kindly request you to cite the following two papers:
